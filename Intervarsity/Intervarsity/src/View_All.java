...
jButton4--Close
jButton3--Refresh
jComboBox4--StudentList
jComboBox5--FilterList
jButton2--Delete Filter
jTextField1--New Filter
JButton1--Save Filter

jCheckBox2--Bible Study
jCheckBox3--Meeting New People
jCheckBox4--Talking about Jesus
jCheckBox5--Finding Local Church
jCheckBox6--Learning about Intervarsity
jCheckBox7--Fun Events
jCheckBox8--Nothing
jCheckBox9--Other
...
jRadioButton12--Off Campus
jComboBox1--Residence Hall List
jRadioButton6--Phone
jRadioButton7--Text
jRadioButton8--Email
jRadioButton9--Neither
jComboBox2--Staff List
jComboBox3--Semester List
jCheckBox10--Face to Face
jCheckBox11--Call/Email
jCheckBox12--2X Connection
jCheckBox13--3X Connection
jCheckBox14--Large Group Invite
jCheckBox15--Small Group Invite
jDateChooser2--Date joined, display all students added after date specified
jButton5--Filter Date, display all students added after date in jDateChooser2
*/
...
public class View_All extends javax.swing.JFrame {
    ...
    //Creates the View_All class & fills the table
    public View_All(String full, Boolean ad, University sch, String sem, int id) {
        ...
        String[] halllist = hall.getHallList();
        ...
        String[] stafflist = staff.getStafflist(school);
        ...
        String[] names = list.getFilterNames();
        ...
        names = semlist.getSemesterNames();
    ...
    ViewAllAttributes old = new ViewAllAttributes();//stores old attributes used
    //              to detect a change 
    ...
    private StudentNode[] student;//holds all the students in student list and get's placed in the table
    //filters the table only display student's matching filter
    private void filtertable(){
        ...
        //Copy filtered students into 2D Object array
        ...
        Object[][] data = new Object[linkedlist.size()][26];//26 for number of columns
        int k = 0;
        student = null;
    ...
    //determines if date specified on datechooser is lessthan date added in StudentNode
    ...
    //copy studentnode into Object array
    ...
    //check if jCheckBox was checked then gets unchecked, if it was, delete student array and reload the array
    ...
    //gets a filter information from FilterList, then sets each item to it desired state
    ...
    //Fetch's each item's state then inserts it as a new filter into FilterList
    ...
    //closes the form and sends it back to previous form
    ...
    //reloads the student table with fresh data
    ...
    //opens a selected student in new view window
    ...
    //updates the table with students in the selected combobox
    ...
    //refreshes the table with fresh data
    ...
    //filters the data in the table showing all contacts added after the date in the date chooser
